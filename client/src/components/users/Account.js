...
class Account extends React.Component {
  ...
  handleChangeCheckbox = () => {
    ...
    this.setState({
      formValues: { ...formValues, comm_prefs: !formValues.comm_prefs },
    });
  };
  ...
  optInView = () => {
    ...
    if (user.comm_prefs === true) {
      return <span> You are subscribed to our communications. &#127752; </span>;
    } else {
      return <span> You are not subscribed to our communications. </span>;
    }
  };
