...
import {
  ...
  Button,
  Form,
} from "../../styled_component/styledComponents";
...
const AddCar = (props) => {
        ...
        return (
          <FormContainer>
            <span>
              ...
              UPLOAD YOUR CAR PHOTO OR RETURN TO DASHBOARD
            </span>
        ...
        <FormContainer>
          ...
          >
            ...
            <FormInput
              ...
              type="checkbox"
            />
            <Button onClick={() => setRedirect(true)}>Save</Button>{" "}
            <Button>Save & Add Photo</Button>
          </form>
        </FormContainer>
      );
    } else {
  ...
  return <div style={styles.container}>{renderForms()}</div>;
};
